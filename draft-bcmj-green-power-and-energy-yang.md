...
informative:
   ...
   GreenFramework: I-D.draft-belmq-green-framework
...
{{GreenFramework}}, following the "GREEN terminology"
{{GreenTerminology}}.
...
The terms reused from {{GreenTerminology}} and
{{GreenFramework}} are capitalized in this
specification.

This document uses the terms Power and Energy in accordance with
{{GreenTerminology}}. Power refers to the instantaneous
...
The "GREEN framework" described in {{GreenFramework}}
